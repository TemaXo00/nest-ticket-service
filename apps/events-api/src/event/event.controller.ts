...
import { Event } from '@org/events-db'
import {
  CreateEventDto,
  UpdateTicketsDto,
  UpdateNameDto,
} from '@org/events-dto';
import { OrgEventsFeatureService } from '@org/events-feature';

@ApiTags('Event')
@Controller('event')
export class EventController {
  constructor(private readonly eventService: OrgEventsFeatureService) {}
